<?php
    ...
    if(isset($_POST['Apply'])){
        ...
        if(isset($_POST['rent'])){
            $query = 'Select * from flat where rent between'.$_POST['rent'];
            $qrow = 'Select * from rowhouse where rent between'.$_POST['rent'];;
            $qbun = 'Select * from bungalow where rent between'.$_POST['rent'];;
            $rrow = pg_query($conn, $qrow);
            $brow = pg_query($conn, $qbun);
            $result = pg_query($conn, $query);
        }
